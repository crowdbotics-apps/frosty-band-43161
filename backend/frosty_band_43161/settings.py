"""
Django settings for frosty_band_43161 project.
...
ROOT_URLCONF = 'frosty_band_43161.urls'
...
WSGI_APPLICATION = 'frosty_band_43161.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_band_43161 API",
    "DESCRIPTION": "API documentation for frosty_band_43161 App",
    "VERSION": "v1",
}
